...
compatibility: Designed for Claude Code. Requires git and commitlint + Husky already configured.
metadata:
...
7. Commit using a HEREDOC to preserve newlines:

```bash
git commit -m "$(cat <<'EOF'
feat(i18n): add Lithuanian translations for hero section
